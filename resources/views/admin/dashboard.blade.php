...
<body>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar">
        <div class="offcanvas-header border-bottom border-secondary">
            <h5 class="offcanvas-title text-white d-flex align-items-center gap-2 mb-0">
                ...
                CoirCraft PH
            </h5> <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">
            <nav class="nav flex-column">
                <a class="nav-link active" href="#"><i class="bi bi-house-door me-3"></i> Dashboard</a>
                <a class="nav-link" href="#"><i class="bi bi-shop me-3"></i> Storefront</a>
                <a class="nav-link" href="#"><i class="bi bi-box-seam me-3"></i> Inventory</a>
                <a class="nav-link" href="#"><i class="bi bi-bar-chart me-3"></i> Reports</a>
            </nav>
        </div>
    </div>
    ...
    <aside class="desktop-sidebar d-none d-lg-block">
        ...
        <div class="position-absolute bottom-0 start-0 p-4 w-100">
            <a class="nav-link small text-danger" href="#"><i class="bi bi-box-arrow-right me-2"></i> Logout</a>
        </div>
    </aside>
